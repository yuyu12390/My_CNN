...
// 2. 内部使用 3 个 pack_mul2_sint4, 总计 3 个 DSP
// 3. 输出 6 路乘积求和结果, 用来验证 neuron 级 packing 潜力
(* keep_hierarchy = "yes" *)
module fc_lane6_pack_sint4
(

...
module cnn_tb;
	...
	reg[10:0] cnt_line_fcw; // 全连接模块权重读取行数计�?
...
// 权重和图像数据加�?
	...
	initial
	begin
		fp_w = $fopen("C:/Users/28010/Desktop/my_cnn/sim/cnn_test/cw.txt","r"); // 卷积模块权重
		fp_wfc = $fopen("C:/Users/28010/Desktop/my_cnn/sim/cnn_test/fcw.txt","r"); // 全连接模块权�?
		fp_i = $fopen("C:/Users/28010/Desktop/my_cnn/sim/cnn_test/0.txt","r"); // 数字 0 
		//fp_all = $fopen("C:/Users/Administrator/Desktop/pic/cnn_test/images_bin.txt","r"); // 所有测试数�?
	end
	...
	always@(posedge clk)
	begin
		if(image_0_tvalid && image_0_tready) // 当滑窗模块开始读取数据时，才输入数据，否则数据错�?
		begin
